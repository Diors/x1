...
public class XoneSsoTokenFilter extends HttpServlet implements Filter {
	...
	private static final long serialVersionUID = 4698762771567488499L;

	private static Logger logger = LoggerFactory.getLogger(XoneSsoTokenFilter.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        // login filter
        XoneSsoUser xxlUser = SsoTokenLoginHelper.loginCheck(req);
        if (xxlUser == null) {
